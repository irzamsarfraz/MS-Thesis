...
![alt text here](class_design.png)
...
![alt text here](implementation_1.png)
![alt text here](implementation_2.png)
...
- colData()
An S4 method that can setor get colData (columns or cells or samples metadata) associated with the current object. In our package, we additionall add support to set or get colData specifically from a subset by specifying the name of the subset in the additional ‘subsetName’ parameter. This data may also include additional information about the samples such as computed clusters or sample information.
- metadata()
...
|Serial No.| Dataset | Dimensions | Sparsity | Type |
| -------- | ------- | ---------- | -------- | ---- |
...
| 19 | pbmc33k | 32738 33148 | 0.9766104 | Real dataset used for testing subset to 9k cells |
...
To compare the results, we utilize 2 approaches overall and multiple datasets:
For both 2 approaches, we use 7 real datasets, 5 sample datasets and 7 simulated datasets.

### Approach 1: dgCMatrix
dgCMatrix is a compressed form of matrices available in R and particularly useful when matrices are sparse since it is able to extensively able to compress the zero cells of the matrix. 

1. Real datasets with extensive sparsity
2. Simulated datasets with near to zero sparsity
3. Sample datasets with extensive sparsity

|Serial No.|Dataset|Dimensions|Avg. Counts/Cell|Sparsity|SCE|ES|Savings|SCE Total Memory|ES Total Memory|Savings|
|----------|-------|----------|----------------|--------|---|--|-------|----------------|---------------|-------|
|1|AztekinTailData|31535 13199|13434.67|0.9296133|1.28 GB|650 MB|49.22|0|0|0|
|2|BachMammaryData|27998 25806|8239.648|0.9152684|2.23 GB|1.16 GB|47.98|0|0|0|
|3|BaronPancreasData('human')|20125  8569|5828.225|0.9062241|718 MB|364 MB|49.3|0|0|0|
|4|BaronPancreasData('mouse')|14878  1886|4990.086|0.8897182|137 MB|73.5 MB|46.35|0|0|0|
|5|KotliarovPBMCData|32738 58654|	2065.245|	0.9780209|	1.92 GB|	1.04 GB|	45.83|	0|	0|	0|
|6|BuettnerESCData|38293   288|	2767864|	0.7440639|	204 MB|	91 MB|	55.39|	0|	0|	0|
|7|CampbellBrainData|26774 21086|	4024.644|	0.9279162|	1.71 GB	|992 MB|	41.99|	0|	0|	0|
|8|Sample sparse dataset  (1)|31535 13199|	283814.4|	0.000123194|	17 GB|	8.33 GB|	51|	0|	0|	0|
|9|Sample sparse dataset  (2)|27998 25806|	251977.7|	0.000123218|	29.5 GB|	14.5 GB|	50.85|	0|	0|	0|
|10|Sample sparse dataset  (3)|20125  8569|	181130.1|	0.000123687|	7.11 GB|	3.45 GB|	51.48|	0|	0|	0|
|11|Sample sparse dataset  (4)|14878  1886|	133908.9|	0.000124662|	1.17 GB|	563 MB|	51.88|	0|	0|	0|
|12|Sample sparse dataset  (5)|32738 58654|	294641.4|	0.000123562|	78.3 GB|	38.4 GB|	50.96|	0|	0|	0|
|13|Sample sparse dataset  (6)|38293   288|	344673.6|	0.000125404|	454 MB|	224 MB|	50.66|	0|	0|	0|
|14|Sample sparse dataset  (7)|26774 21086|	240964.1|	0.000123049|	23.1 GB|	11.3 GB|	51.08|	0|	0|	0|
|15|pbmc3k|32738  2700|2366.9|	0.9741281|	16.3 MB|	7.16 MB|	56.07|	7743.2 MB|	4485.3 MB| 0 |	
|16|pbmc4k|33694  4340|4349.038|	0.9608314|	19.1 MB|	8.08 MB|	57.7|	0	|0|	0|
|17|pbmc6k|32738  5419|2027.635|	0.9771501|	18.5 MB|	8.37 MB|	54.76|	0|	0|	0|
|18|pbmc8k|33694  8381|4639.048|	0.9582552|	24 MB|	9.93 MB|	58.63|	0	|0|	0|
|19|pbmc33k|32738 33148|2057.882|	0.9766104|	43.8 MB|	20.6 MB|	52.97|	83494 MB|	54734.7 MB|	34.44|
...
|Serial No.|Dataset|Dimensions|Avg. Counts/Cell|Sparsity|SCE|ES|Savings|SCE Total Memory|ES Total Memory|Savings|
|----------|-------|----------|----------------|--------|---|--|-------|----------------|---------------|-------|
|1|	AztekinTailData|	31535 13199|	13434.67|	0.9296133|	10.2 GB|	4.67 GB|	54.22|	0|	0|	0|
|2|	BachMammaryData| 27998 25806|	8239.648|	0.9152684|	17.8 GB|	8.11 GB|	54.44|	0|	0|	0|
|3|	BaronPancreasData('human')|	20125  8569|	5828.225|	0.9062241|	4.28 GB|	1.94 GB|	54.67|	0|	0|	0|
|4|	BaronPancreasData('mouse')|	14878  1886|	4990.086|	0.8897182|	681 MB|	317 MB|	53.45|	0|	0|	0|
|5|	KotliarovPBMCData|	32738 58654|	2065.245|	0.9780209|	39 GB|	21.6 GB|	44.62|	0|	0|	0|
|6|	BuettnerESCData|	38293   288|	2767864|	0.7440639|	204 MB|	91 MB|	55.39|	0|	0|	0|
|7|	CampbellBrainData|	26774 21086|	4024.644|	0.9279162|	12.6 GB|	6.33 GB|	49.76|	0|	0|	0|
|8|	Sample sparse dataset  (1)|	31535 13199|	283814.4|	0.000123194|	6.83 GB|	3 GB|	56.08|	0|	0|	0|
|9|	Sample sparse dataset  (2)|	27998 25806|	251977.7|	0.000123218|	11.9 GB|	5.21 GB|	56.22|	0|	0|	0|
|10|	Sample sparse dataset  (3)|	20125  8569|	181130.1|	0.000123687|	2.87 GB|	1.25 GB|	56.45|	0|	0|	0|
|11|	Sample sparse dataset  (4)|	14878  1886|	133908.9|	0.000124662|	475 MB|	204 MB	|57.05|	0|	0|	0|
|12|	Sample sparse dataset  (5)|	32738 58654|	294641.4|	0.000123562|	31.5 GB|	13.8 GB|	56.19|	0|	0|	0|
|13|	Sample sparse dataset  (6)|	38293   288|	344673.6|	0.000125404|	186 MB|	83.1 MB|	55.32|	0|	0|	0|
|14|	Sample sparse dataset  (7)|	26774 21086|	240964.1|	0.000123049|	9.3 GB|	4.07 GB|	56.24|	0|	0|	0|
|15|	pbmc3k|	32738  2700|	2366.9|	0.9741281|	1.29 GB|	644 MB|	50.08|	2700.4 MB|	2148.1 MB|	0|
|16|	pbmc4k|	33694  4340|	4349.038|	0.9608314|	2.39 GB|	1.06 GB|	55.65|	0|	0|	0|
|17|	pbmc6k|	32738  5419|	2027.635|	0.9771501|	2.31 GB|	1.29 GB|	44.16|	0|	0|	0|
|18|	pbmc8k|	33694  8381|	4639.048|	0.9582552|	4.63 GB|	2.04 GB|	55.94|	0|	0|	0|
|19|	pbmc33k|	32738 33148|	2057.882|	0.9766104|	14.2 GB|	7.83 GB|	44.86|	0|	0|	0|


In both approach 1 and 2, we compare the size of the resultant objects as well as the memory consumed during the example workflow.

![alt text here](results.png)
...
## Conclusion
- ES package offers this
- Results show that it is efficient

## Limitations
Analysis should have subsets and depends on sparsity and counts per cell
diff in 0 and nonzero sizes is due to 0 occupying more memory

## Future Work
- works with available 5 classes and all general expression data, but need to generalize it for multiassaydata 
