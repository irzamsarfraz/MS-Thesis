...
### Approach 2: Matrix
Matrix is the standard form of 2D matrices in R and is non-compressed... 
...
In both approach 1 and 2, we compare the size of the resultant objects. We see that memory is saved .....

![alt text here](results.png)

describe results more in detail ...
