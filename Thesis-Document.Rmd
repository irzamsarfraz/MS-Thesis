...
# Results & Discussion
Based on the implementation above, we created the R package "ExperimentSubset" and tested the package on a sample workflow using a number of datasets described below:
