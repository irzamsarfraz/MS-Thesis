...
topHVG1000SCE <- scran::getTopHVGs(scran::modelGeneVar(assay(sce2, "filteredCellsNormalized")), n = 1000)

# ExperimentSubset
es <- readRDS("esValidation.rds")
topHVG1000ES <- scran::getTopHVGs(scran::modelGeneVar(assay(es, "filteredCellsNormalized")), n = 1000)
